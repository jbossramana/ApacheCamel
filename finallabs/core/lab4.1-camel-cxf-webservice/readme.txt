This Exercises shows how a Web Service can be exposed in a Camel route using Spring DSL language. 
The first camel routes consumes a text file and creates a WebService request to save the customer.
...
2) Open your favotite browser and points to the following address to check the wsdl

    http://localhost:9090/training/WebService?wsdl

3) Start soapui and create a project using the previous address. Next, send the following requests

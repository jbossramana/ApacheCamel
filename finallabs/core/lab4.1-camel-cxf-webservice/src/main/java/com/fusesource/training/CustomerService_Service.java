 ...
 * 2021-03-10T08:33:15.690+05:30
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "CustomerService",
                  wsdlLocation = "file:/C:/ApacheCamel/labs/camel-webservice-proxy/src/main/resources/META-INF/wsdl/CustomerService.wsdl",
...
public class CustomerService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/ApacheCamel/labs/camel-webservice-proxy/src/main/resources/META-INF/wsdl/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/ApacheCamel/labs/camel-webservice-proxy/src/main/resources/META-INF/wsdl/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }

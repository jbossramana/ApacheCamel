 ...
 * 2023-03-18T12:37:05.301+05:30
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "ReportIncidentEndpointService",
                  wsdlLocation = "file:/E:/ApacheCamel/finallabs/core/lab4.2-camel-example-cxf-proxy/src/main/resources/etc/report_incident.wsdl",
...
public class ReportIncidentEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/ApacheCamel/finallabs/core/lab4.2-camel-example-cxf-proxy/src/main/resources/etc/report_incident.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ReportIncidentEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/ApacheCamel/finallabs/core/lab4.2-camel-example-cxf-proxy/src/main/resources/etc/report_incident.wsdl");
        }
        WSDL_LOCATION = url;
    }

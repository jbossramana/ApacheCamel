...
public class PaymentCurrencyTestWithTxRouter
	...
	public void configure() throws Exception {
        ...
        errorHandler(
            transactionErrorHandler( txnPropagationRequired ).redeliveryDelay( 5000 )
        );

        IdempotentRepository idempotentRepository = lookup( "processedMessagesRepository", IdempotentRepository.class);
	...
	public void afterPropertiesSet() throws Exception {
		...
		sourceUri = "activemq:" + incomingQueue;
		targetUri = "activemq:" + outgoingQueue;
	}
